...
const PerformanceTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://dashboardbe-4.onrender.com/api/performance');
    ...
    const handleSave = async () => {
        if (isNew) {
            try {
                const response = await axios.post('https://dashboardbe-4.onrender.com/api/performance', formData);
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.put(`https://dashboardbe-4.onrender.com/api/performance/${selectedPerformance._id}`, formData);
    ...
    const handleDelete = async (id) => {
      try {
          await axios.delete(`https://dashboardbe-4.onrender.com/api/performance/${id}`);
